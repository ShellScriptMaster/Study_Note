...
fun8(10,20,30,40,50,60)
alst = [1,2,3,5,5,5,532,4,234,234,234,34,23,42]
...
# 内置函数  max,min,pow,sum,pow,slice(切片)
print('*' * 30, '内置函数', '*' * 30)
a = 2
b = 10
...
fun_list = [22,22,33,4,15,6,84,1,13,321,843,1,48,7,84,154,5,3]
print('Max = ', max(fun_list))
print('Min = ', min(fun_list))
print('Sum = ', sum(fun_list))
